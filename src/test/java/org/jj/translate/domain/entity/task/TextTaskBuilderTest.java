...
class TextTaskBuilderTest {
    ...
    void build_IdIsNull_ThrowEx() {
        var sourceLang = Lang.of(StringGenerator.getRandomString());
        var sourceText = Text.of(StringGenerator.getRandomString());
        var targetLang = Lang.of(StringGenerator.getRandomString());
        var translatedText = Text.of(StringGenerator.getRandomString());
